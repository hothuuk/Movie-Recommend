package com.study.movierecommend.global.error.handler

import com.study.movierecommend.global.error.exception.BasicException
import com.study.movierecommend.global.error.ErrorResponse
...
class GlobalExceptionHandler {
    ...
    fun basicExceptionHandler(request: HttpServletRequest, ex: BasicException): ResponseEntity<ErrorResponse> {
        ...
        return ResponseEntity<ErrorResponse>(errorResponse, HttpStatus.valueOf(ex.errorCode.status))
    }
}